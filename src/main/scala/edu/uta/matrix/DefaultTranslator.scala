...
object DefaultTranslator extends Typechecker {
  import AST._
                  ...
                  => val nv = newvar
                     update(u,
                            Comprehension(option,
                                          Record(cs.map {
                                              case (v,_)
                                                => v -> (if (v == a) Var(nv) else Project(u,v))
                                          }),
                                          List(Generator(VarPat(nv),value))),
          ...
          case Block(ss)
            => val (nstate,_,_) = ss.foldLeft(( state, globals, locals )) {
                    case ((ns,gs,ls),DeclareVal(v,t,e))
                      => ( update(Var(v),translate(e,ns,gs,ls),ns,gs,ls),
                           gs, ls+((v,t)) )
                    case ((ns,gs,ls),DeclareVar(v,t,Var("null")))
                      => ( update(Var(v),Elem(option,Undefined(t)),ns,gs+((v,t)),ls),
                           gs+((v,t)), ls )
                    case ((ns,gs,ls),DeclareVar(v,t,e))
                      => ( update(Var(v),translate(e,ns,gs,ls),ns,gs+((v,t)),ls),
                           gs+((v,t)), ls )
                    case ((ns,gs,ls),stmt)
